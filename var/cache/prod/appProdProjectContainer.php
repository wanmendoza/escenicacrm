...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'postPersist', 1 => 'postUpdate', 2 => 'postRemove', 3 => 'prePersist', 4 => 'preUpdate'), $this->get('base.change.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'escenicacrm', 'user' => 'root', 'password' => 'wanmendoza88', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2f0ae8d90c205695f303f00b3164486ef92ee9f08dd326d1a98081d90dcd05f5');
    ...
    {
        return $this->services['form.type_extension.upload.validator'] = new \Symfony\Component\Form\Extension\Validator\Type\UploadValidatorExtension($this->get('lexik_translation.translator'), 'validators');
    }
    ...
    {
        return $this->services['fos_user.listener.flash'] = new \FOS\UserBundle\EventListener\FlashListener($this->get('session'), $this->get('lexik_translation.translator'));
    }
    ...
    {
        $this->services['lexik_translation.translator'] = $instance = new \Lexik\Bundle\TranslationBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json'), 'lexik_translation.loader.database' => array(0 => 'database')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => false), $this->get('session', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    ...
    {
        return $this->services['time.datetime_formatter'] = new \Knp\Bundle\TimeBundle\DateTimeFormatter($this->get('lexik_translation.translator'));
    }
    ...
    {
        return $this->services['translator_listener'] = new \Symfony\Component\HttpKernel\EventListener\TranslatorListener($this->get('lexik_translation.translator'), $this->get('request_stack'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'FOSUserBundle', 1 => 'WbcAdministratorBundle', 2 => 'WbcThemeBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        ...
        $instance->addGlobal('project', array('name' => 'Base', 'tradename' => 'Base project by Rodmar Zavala'));
    ...
    {
        return $this->services['vich_uploader.form.type.file'] = new \Vich\UploaderBundle\Form\Type\VichFileType($this->get('vich_uploader.storage'), $this->get('vich_uploader.upload_handler'), $this->get('lexik_translation.translator'));
    }
    ...
    {
        return $this->services['vich_uploader.form.type.image'] = new \Vich\UploaderBundle\Form\Type\VichImageType($this->get('vich_uploader.storage'), $this->get('vich_uploader.upload_handler'), $this->get('lexik_translation.translator'));
    }
