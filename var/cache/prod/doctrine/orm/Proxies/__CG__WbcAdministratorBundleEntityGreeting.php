 ...
 */
class Greeting extends \Wbc\AdministratorBundle\Entity\Greeting implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\Greeting' . "\0" . 'id', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\Greeting' . "\0" . 'name', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\Greeting' . "\0" . 'name_es', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\Greeting' . "\0" . 'name_en', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\Greeting' . "\0" . 'user'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Greeting $proxy) {
