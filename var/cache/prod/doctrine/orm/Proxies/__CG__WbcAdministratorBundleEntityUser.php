 ...
 */
class User extends \Wbc\AdministratorBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'formal', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\User' . "\0" . 'first_name', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\User' . "\0" . 'last_name', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\User' . "\0" . 'locale', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\User' . "\0" . 'greeting', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\User' . "\0" . 'timezone', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\User' . "\0" . 'birthday', '' . "\0" . 'Wbc\\AdministratorBundle\\Entity\\User' . "\0" . 'role', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
