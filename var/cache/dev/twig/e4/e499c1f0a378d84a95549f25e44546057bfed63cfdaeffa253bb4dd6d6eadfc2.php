...
/* WbcThemeBundle:Partials:chat.html.twig */
class __TwigTemplate_e5aff3a500b8d144acd4ec5d15dbabb2c9f132a30c54476202ae7e88382707e5 extends Twig_Template
{
    ...
    {
        $__internal_5d377a04a61bd391ad06cfa6e4e06365bbe398536890caa19f78a3d812067e0a = $this->env->getExtension("native_profiler");
        $__internal_5d377a04a61bd391ad06cfa6e4e06365bbe398536890caa19f78a3d812067e0a->enter($__internal_5d377a04a61bd391ad06cfa6e4e06365bbe398536890caa19f78a3d812067e0a_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "WbcThemeBundle:Partials:chat.html.twig"));

        
        $__internal_5d377a04a61bd391ad06cfa6e4e06365bbe398536890caa19f78a3d812067e0a->leave($__internal_5d377a04a61bd391ad06cfa6e4e06365bbe398536890caa19f78a3d812067e0a_prof);

    }

    public function getTemplateName()
    {
        return "WbcThemeBundle:Partials:chat.html.twig";
    }
...
/*             <h4 class="chat-sidebar-title">{% trans %}Contacts{% endtrans %}</h4>*/
/*             <div class="form-group no-margin">*/
/*                 <div class="input-group input-group-dark">*/
/*                     <input class="form-control fs-mini" id="chat-sidebar-search" type="text" placeholder="{% trans %}Search...{% endtrans %}">*/
...
/*             <h5 class="sidebar-nav-title">{% trans %}Today{% endtrans %}</h5>*/
...
/*                     <i class="fa fa-circle text-gray-light pull-right"></i>*/
/*                 <span class="thumb-sm pull-left mr">*/
/*                     <img class="img-circle" src="/base/demo/img/people/a6.jpg" alt="...">*/
/*                 </span>*/
...
/*                 <span class="thumb-sm pull-left mr">*/
/*                     <img class="img-circle" src="/base/demo/img/people/a3.jpg" alt="...">*/
/*                 </span>*/
/*                     <h5 class="message-sender">Jaron Fitzroy</h5>*/
/*                     <p class="message-preview">What about summer break?</p>*/
/*                 </a>*/
...
/*             <input class="form-control input-dark fs-mini" id="chat-sidebar-input" type="text"  placeholder="{% trans %}Type your message{% endtrans %}">*/
/*         </footer>*/
/*     </div>*/
/* </div>*/
/* #}*/
